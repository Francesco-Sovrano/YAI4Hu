...
class ConceptClassifier(SentenceClassifier):
	...
	def get_concept_dict(self, doc_parser: DocParser, concept_counter_dict=None, similarity_threshold=None, with_numbers=True, size=None, remove_stopwords=True, lemmatized=True, tfidf_importance=None, filter_extra_fn=None):
		...
		if filter_extra_fn:
			filter_fn_list.append(filter_extra_fn)
		if with_numbers:
