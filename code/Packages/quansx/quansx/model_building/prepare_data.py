...
class DataTrainingArguments:
    ...
    """
    task: str = field(
        metadata={"help": "Which task 'multi', 'question_answer_gen', 'e2e_question_answer_gen', 'e2e_question_gen', 'e2e_answer_gen', 'answer_gen', 'question_gen'. 'multi' means 'question_answer_gen', 'e2e_question_answer_gen' tasks"}, 
    )
    data: str = field(
